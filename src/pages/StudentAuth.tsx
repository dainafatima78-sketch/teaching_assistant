    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/20 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          />
          <h1 className="text-xl sm:text-2xl font-bold text-foreground text-center">Student Portal</h1>
          <p className="text-sm text-muted-foreground mt-1">Login or create account to take quizzes</p>
        </div>
        ...
        <Card className="border-primary/20 shadow-lg">
          <CardHeader className="text-center bg-primary/5 rounded-t-lg">
            ...
            <CardDescription>
              Access quizzes shared by your teachers
            </CardDescription>
          </CardHeader>
